<template>
              ...
              <div class="col-md-12">
                <div class="card shadow-sm border-0 rounded">
                  <div class="card-header bg-white border-0">
                    <h5 class="card-title text-dark fw-bold">ESTE ES EL TÍTULO DEL CARD</h5>
                  </div>
                  <div class="card-body scrollable-card-body">
                    <!-- Aquí agregas tu contenido que puede ser largo -->
                    <p class="card-text">ESTE ES EL BODY DEL CARD</p>
                    <!-- Agrega más contenido aquí -->
                    <!-- Ejemplo de contenido largo -->
                    <div>
                      <!-- Repite este párrafo varias veces para simular contenido largo -->
  ...
  export default {
    ...
    data() {
      return {
        titulo: 'Mis Eventos',
        descripcion: 'Aqupi puedes ver todos tus eventos',
